...
func (s *Server) routes() {
	...
	m.HandleFunc("DELETE /api/workspaces", s.handleRemoveWorkspace)
	m.HandleFunc("PUT /api/project-folders", s.handleUpdateProjectFolders)
	m.HandleFunc("GET /api/sessions", s.handleListAllSessions)
	m.HandleFunc("GET /api/sessions/live", s.handleListLiveSessions)
	m.HandleFunc("PUT /api/sessions/{sessionId}/starred", s.handleSetSessionStarred)
